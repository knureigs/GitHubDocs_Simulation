...
<!-- Максимальна оцінка буде зменшуватись по мірі попиту на завдання. Була 15 раніше. Теперь 20. -->
...
Бот стикування до МКС. На кшталт показаного на одній з лекцій, для [онлайн-тренажера](https://iss-sim.spacex.com/). <!-- Код, как вариант для переделываемой основы - https://habr.com/ru/post/502072/. При демонстрации стыковка должна закончиться удачно, иначе минус 5 баллов. -->
Максимальна оцінка: **15** балів.
<!-- Максимальна оцінка буде зменшуватись по мірі попиту на завдання. -->
...
Максимальна оцінка: **40** балів.
<!-- Максимальна оцінка буде зменшуватись по мірі попиту на завдання. Була 25 раніше. -->
...
При виборі для перекладу великого фрагмента документації, рекомендується працювати в колективі співавторів, для єдності термінології, що використовується, і зручності контролю якості з мого боку. <!-- Пріоритет не у швидкості, а у якості. -->  
...
<!-- Задача не программистская и не особо творческая, да ещё и балл поднял по сравнению с прошлым годом (там было 1 балл за 1000 знаков). -->  
